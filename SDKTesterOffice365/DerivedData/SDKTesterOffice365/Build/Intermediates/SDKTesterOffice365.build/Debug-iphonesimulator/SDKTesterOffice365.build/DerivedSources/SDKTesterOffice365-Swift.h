...
SWIFT_CLASS("_TtC18SDKTesterOffice36511AppDelegate")
...
SWIFT_CLASS("_TtC18SDKTesterOffice36520DetailViewController")
...
SWIFT_CLASS("_TtC18SDKTesterOffice36520MasterViewController")
@interface MasterViewController : UITableViewController <UITableViewDataSource>
@property (nonatomic) NSMutableArray * objects;
@property (nonatomic, copy) NSArray * spItems;
@property (nonatomic, copy) NSArray * breadcrumb;
@property (nonatomic, weak) IBOutlet UINavigationItem * navItem;
@property (nonatomic, weak) IBOutlet UIActivityIndicatorView * spinner;
@property (nonatomic) IBOutlet UITableView * tblView;
- (void)awakeFromNib;
- (void)viewDidLoad;
- (void)loadItems:(NSString *)id;
- (void)didReceiveMemoryWarning;
- (BOOL)shouldPerformSegueWithIdentifier:(NSString *)identifier sender:(id)sender;
- (void)upFolderLevel:(UIBarButtonItem *)sender;
